 ...
 */
public class ConcentrationSiteClientProxy extends Thread implements MasterThiefCloning, OrdinaryThiefCloning
{
    /**
    ...
    */
    ...
    /**
    *  Interface to the Concentration Site of Information.
    */
    private ConcSiteInterface concSiteInter;
    ...
    *     @param concSiteInter interface to the concentration site of information
    */
    public ConcentrationSiteClientProxy (ServerCom sconi, ConcSiteInterface concSiteInter)
    {
        super ("ConcentrationSiteProxy_" + ConcentrationSiteClientProxy.getProxyId ());
        this.sconi = sconi;
        this.concSiteInter = concSiteInter;
    }
    ...
    public void run ()
    {
        ...
        try
        { outMessage = concSiteInter.processAndReply (inMessage);    // process it
        }
