...
/**
 *  Service provider agent for access to the Control and Collection Site.
 *
 *    Implementation of a client-server model of type 2 (server replication).
 *    Communication is based on a communication channel under the TCP protocol.
 */
public class ControlCollecSiteClientProxy extends Thread implements MasterThiefCloning,  OrdinaryThiefCloning
{
    /**
    ...
    */
    ...
    /**
    *  Interface to the Control and Collection Site of Information.
    */
    private ControlCollecSiteInterface controlCollecSiteInter;
    ...
    *     @param controlCollecSiteInter interface to the control and collection cite of information
    */
    public ControlCollecSiteClientProxy (ServerCom sconi, ControlCollecSiteInterface controlCollecSiteInter)
    {
        super ("ControlCollecSiteClientProxy" + ControlCollecSiteClientProxy.getProxyId ());
        this.sconi = sconi;
        this.controlCollecSiteInter = controlCollecSiteInter;
    }
    ...
    {
        Class<?> cl = null;          // representation of the ControlCollecSiteClientProxy object in JVM
        int proxyId;                 // instantiation identifier

        try
        { cl = Class.forName ("serverSide.entities.ControlCollecSiteClientProxy");
        }
        catch (ClassNotFoundException e)
        { GenericIO.writelnString ("Data type ControlCollecSiteClientProxy was not found!");
        e.printStackTrace ();
        System.exit (1);
        }
        synchronized (cl)
    ...
    public void run ()
    {
        ...
        try
        { outMessage = controlCollecSiteInter.processAndReply (inMessage);    // process it
        }
