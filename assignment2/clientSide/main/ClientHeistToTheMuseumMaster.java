...
public class ClientHeistToTheMuseumMaster
{
    ...
    public static void main (String [] args)
    {
        ...
        AssaultPartyStub [] assaultPartiesStub = new AssaultPartyStub[SimulPar.NUM_ASSAULT_PARTIES];    // reference to the assault parties
        ...
        for (int i = 0; i < SimulPar.NUM_ASSAULT_PARTIES; i++)
        {
            ...
            assaultPartiesStub[i].initAssaultPartyID(i);
        }        
        genReposStub = new GeneralRepositoryStub (genReposServerHostName, genReposServerPortNumb);
        //genReposStub.initSimul("log.txt"); 
        
        masterThief = new MasterThief("MasterThief", concentrationSiteStub, controlCollectionSiteStub, assaultPartiesStub);
