...
sshpass -f password ssh sd406@l040101-ws06.ua.pt 'cd HeistToTheMuseum/dirAssaultParty0 ; java serverSide.main.ServerHeistMuseumAssaultP0 22454 l040101-ws01.ua.pt 22450'

echo "Server Assault Party 0 shutdown."
