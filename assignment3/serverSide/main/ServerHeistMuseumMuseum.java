 ...
 */
public class ServerHeistMuseumMuseum
{
    /**
    ...
    public static void main (String[] args)
    {
        ...
        try
        { while (!end)
            synchronized (Class.forName ("serverSide.main.ServerHeistMuseumMuseum"))
            { try
            { (Class.forName ("serverSide.main.ServerHeistMuseumMuseum")).wait ();
            }
        ...
        { GenericIO.writelnString ("The data type ServerHeistMuseumMuseum was not found (blocking)!");
        e.printStackTrace ();
        System.exit (1);
        }
    ...
    public static void shutdown ()
    {
        ...
        try
        { synchronized (Class.forName ("serverSide.main.ServerHeistMuseumMuseum"))
        { (Class.forName ("serverSide.main.ServerHeistMuseumMuseum")).notify ();
        }
        }
        catch (ClassNotFoundException e)
        { GenericIO.writelnString ("The data type ServerHeistMuseumMuseum was not found (waking up)!");
        e.printStackTrace ();
        System.exit (1);
        }
    }
