 ...
 */
public class ServerHeistMuseumGeneralRepos
{
  /**
   ...
   *        @param args[2] - port nunber where the registering service is listening to service requests
   */
  public static void main(String[] args)
  {
    ...
    try
    { while (!end)
        synchronized (Class.forName ("serverSide.main.ServerHeistMuseumGeneralRepos"))
        { try
          { (Class.forName ("serverSide.main.ServerHeistMuseumGeneralRepos")).wait ();
          }
    ...
    { GenericIO.writelnString ("The data type ServerHeistMuseumGeneralRepos was not found (blocking)!");
      e.printStackTrace ();
      System.exit (1);
    }
  ...
  public static void shutdown ()
  {
    ...
    try
    { synchronized (Class.forName ("serverSide.main.ServerHeistMuseumGeneralRepos"))
      { (Class.forName ("serverSide.main.ServerHeistMuseumGeneralRepos")).notify ();
      }
    }
    catch (ClassNotFoundException e)
    { GenericIO.writelnString ("The data type ServerHeistMuseumGeneralRepos was not found (waking up)!");
      e.printStackTrace ();
      System.exit (1);
    }
  }
